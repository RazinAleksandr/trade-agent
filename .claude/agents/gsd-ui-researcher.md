...
Use template from `/Users/aleksandrrazin/work/polymarket-agent/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/Users/aleksandrrazin/work/polymarket-agent/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/Users/aleksandrrazin/work/polymarket-agent/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
